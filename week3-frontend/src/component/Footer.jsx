...
// import { FiBell, FiUser} from 'react-icons/fa';
...
//               {/* <FaSearch size={24} /> */}
//             </Nav.Link>
//             <a className="action_container" style={{color:'azure'}} onClick={toggleSlider}><CiFilter size={24} className='icon'/></a>
//             <FiBell className="me-4 ms-4 icon" size={24} />
//             <link to="/account" onClick={toggleSliders} style={{color:'azure'}}><FiUser size={24} className='icon'/></link>
//           </Nav>
//         </Navbar>
//       </Navbar>
