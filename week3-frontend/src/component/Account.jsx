                ...
                {email ? (
                    <>
                        <div style={{marginBottom:"30px"}} >
                            {/* <FaEnvelope  /> */}
                            <h4>Name:</h4><span className="fw-bold" style={{color:"blue",marginLeft:"-14px"}}>{name}</span>
                            <br></br>
                            <h4>Email:</h4><span className="fw-bold" style={{color:"blue",marginLeft:"-14px"}}>{email}</span>
                        </div>
